...
% Ferry
FerryInVehicleTimeFilePath='LOS/Ferry/NoWaitingTimeNoGothenburgFerryRouting/InVehicleTime.xlsx';
FerryHeadwayPath='LOS/Ferry/NoWaitingTimeNoGothenburgFerryRouting/Headway.xlsx';
FerryAccessEgressTimePath='LOS/Ferry/NoWaitingTimeNoGothenburgFerryRouting/AccessEgressTime.xlsx';
FerryCostPath='LOS/Ferry/NoWaitingTimeNoGothenburgFerryRouting/TravelCost.xlsx';
FerryDistancePath='LOS/Ferry/NoWaitingTimeNoGothenburgFerryRouting/TravelDistanceKM_Ferry.xlsx';
DistancePath='LOS/Ferry/NoWaitingTimeNoGothenburgFerryRouting/TravelDistanceKM.xlsx';
FerryNumberLineUsedPath='LOS/Ferry/NoWaitingTimeNoGothenburgFerryRouting/NumberOfFerryLinesUsed.xlsx';
...
% sällskap
RVU.PartySizeFactor=RVU.sallskap;
RVU.PartySizeFactor(RVU.sallskap<=0)=1/1.874;
RVU.PartySizeFactor(RVU.sallskap==1)=1;
RVU.PartySizeFactor(RVU.sallskap>1)=0.5;
% number car
RVU.BILANT(isnan(RVU.BILANT))=0;

% income
RVU.lowMediumIncome=RVU.HHINK<300000;
...
TrainWeightedTotalTime(2:end,2:end)=TrainInVehicleTime(2:end,2:end)+1.36*TrainAccessEgressTime(2:end,2:end);
...
AirWeightedTotalTime(2:end,2:end)=AirInVehicleTime(2:end,2:end)+1.36.*AirAccessEgressTime(2:end,2:end);
...
level_of_service_var_bus.inVehicleTimeBusTrain=busTime;
...
level_of_service_var_train.inVehicleTimeBusTrain=TrainWeightedTotalTime;
...
level_of_service_var_air.inVehicleTimeBusTrain=AirWeightedTotalTime;
