...
% Train
TrainImpedanceFilePath='LOS/Train/EMMEWeightsAndBusNetworkAsAccessEgress/Impedans.xlsx';
...
trainCost(2:end,2:end)=trainDistance(2:end,2:end).*0.17553+(1).*21.09441+trainAccessEgressDistance(2:end,2:end)*0.18; % high
...
% trainCost(2:end,2:end)=trainDistance(2:end,2:end).*0.212784; % high no intercept
...
trainCostLog_increase=trainCost;
trainCostLog_increase(2:end,2:end)=log(trainCost(2:end,2:end).*1.1+0.01);
...
predictionBaseline=Apply_NL_model(final_result,...
    RVU_bortavaror,...
    RVU,...
    model_specification_modeChoice,...
    ZoneData,...
    ...
    Origin_varname,...
    Destination_varname);
RVU.baseline_Probability_car=predictionBaseline.probability_fullData(:,1);
RVU.baseline_Probability_bus=predictionBaseline.probability_fullData(:,2);
RVU.baseline_Probability_train=predictionBaseline.probability_fullData(:,3);
RVU.baseline_Probability_air=predictionBaseline.probability_fullData(:,4);
...
prediction_scenario=Apply_NL_model(final_result,...
    RVU_bortavaror,...
    RVU,...
    model_specification_modeChoice,...
    ZoneData,...
    ...
    Origin_varname,...
    Destination_varname);
RVU.trainCostIncreaseScenario_Probability_car=prediction_scenario.probability_fullData(:,1);
RVU.trainCostIncreaseScenario_Probability_bus=prediction_scenario.probability_fullData(:,2);
RVU.trainCostIncreaseScenario_Probability_train=prediction_scenario.probability_fullData(:,3);
RVU.trainCostIncreaseScenario_Probability_air=prediction_scenario.probability_fullData(:,4);
RVU.trainCostIncreaseScenario_logsum=prediction_scenario.logsum_fullData;
...
prediction_scenario=Apply_NL_model(final_result,...
    ...
    Origin_varname,...
    Destination_varname);
RVU.trainInVehTimeDecreaseScenario_Probability_car=prediction_scenario.probability_fullData(:,1);
RVU.trainInVehTimeDecreaseScenario_Probability_bus=prediction_scenario.probability_fullData(:,2);
RVU.trainInVehTimeDecreaseScenario_Probability_train=prediction_scenario.probability_fullData(:,3);
RVU.trainInVehTimeDecreaseScenario_Probability_air=prediction_scenario.probability_fullData(:,4);
RVU.trainInVehTimeDecreaseScenario_logsum=prediction_scenario.logsum_fullData;
...
prediction_scenario=Apply_NL_model(final_result,...
    ...
    Origin_varname,...
    Destination_varname);
RVU.trainWaitingTimeDecreaseScenario_Probability_car=prediction_scenario.probability_fullData(:,1);
RVU.trainWaitingTimeDecreaseScenario_Probability_bus=prediction_scenario.probability_fullData(:,2);
RVU.trainWaitingTimeDecreaseScenario_Probability_train=prediction_scenario.probability_fullData(:,3);
RVU.trainWaitingTimeDecreaseScenario_Probability_air=prediction_scenario.probability_fullData(:,4);
RVU.trainWaitingTimeDecreaseScenario_logsum=prediction_scenario.logsum_fullData;
...
prediction_scenario=Apply_NL_model(final_result,...
    ...
    Origin_varname,...
    Destination_varname);
RVU.trainCombinedScenario_Probability_car=prediction_scenario.probability_fullData(:,1);
RVU.trainCombinedScenario_Probability_bus=prediction_scenario.probability_fullData(:,2);
RVU.trainCombinedScenario_Probability_train=prediction_scenario.probability_fullData(:,3);
RVU.trainCombinedScenario_Probability_air=prediction_scenario.probability_fullData(:,4);
RVU.trainCombinedScenario_logsum=prediction_scenario.logsum_fullData;
