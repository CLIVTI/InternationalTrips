...
beta_names_fix.(choice_name{2})={'Trip_ASC','Trip_AntalBilar','Trip_female','Trip_age_31_64','Trip_age_64','Trip_highIncome','Trip_summer','Trip_Jul','logsum'};   % 'logsum'
X_names_fix.(choice_name{2})={'ASC','BILANT','female','age_31_64','age_64','highIncome','summer','Jul','logsumBortavaro'};    % 'logsumBortavaro'
