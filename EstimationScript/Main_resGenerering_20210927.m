...
beta_names_fix.(choice_name{3})={'1_5Natt_ASC','1_5Natt_age_17','1_5Natt_highIncome','1_5Natt_incomeMissing','1_5Natt_summer','1_5Natt_Jul','1_5Natt_AntalSmallBarn','1_5Natt_AntalStoreBarn','1_5Natt_Logsum'};   % ICEV
X_names_fix.(choice_name{3})={'ASC','age_17','highIncome','incomeMissing','summer','Jul','AntalSmallBarn','AntalStoreBarn','logsumBortavaro_2'};    % ICEV
