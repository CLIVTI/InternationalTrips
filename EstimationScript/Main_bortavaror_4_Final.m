...
beta_names_fix.(mode_choice_names{2})={'bus_ASC','bus_VILLA','bus_age_64'};  
X_names_fix.(mode_choice_names{2})={'ASC','VILLA','age_64'};  

beta_names_fix.(mode_choice_names{3})={'train_ASC'};   
X_names_fix.(mode_choice_names{3})={'ASC'};  

beta_names_fix.(mode_choice_names{4})={'air_ASC','air_female','air_VILLA'};  
X_names_fix.(mode_choice_names{4})={'ASC','female','VILLA'};  
